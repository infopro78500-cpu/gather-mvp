...
3. **Les formats > 40×60 en rigide** : contrecollage (tirage Latex marouflé) confirmé ? Quel temps de main-d'œuvre par pièce ? *Détermine si la grille tient jusqu'au 100×150 avant la Gongzheng.*
   → **La découpe, elle, est résolue** : l'atelier a une **Summa F1612 avec kit de fraisage** (160 × 120 cm, ±0,05 mm — confirmé le 08/08/2026). Le fraisage coupe Dibond, acrylique, PVC et bois, donc **tous les formats du catalogue V1 se sortent en interne**, jusqu'au 100×150 inclus. La découpe de forme devient un différenciant à coût quasi nul (le marché la facture +100 € HT minimum), et le **V-Cut** ouvre la fabrication maison de chevalets et supports pliés. Détail : `presentoir-nfc.md` §11.
   ⚠️ **À anticiper** : la Gongzheng imprimera 250 × 130 cm mais la Summa ne découpe que 160 × 120 — à son arrivée, **c'est la découpe qui deviendra le goulot**, pas l'impression.
