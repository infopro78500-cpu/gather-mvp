...
export function QRCodeGarlandFrame({ children }: QRCodeGarlandFrameProps) {
  return (
    <div className="relative inline-block">
      ...
      <div className="relative rounded-2xl bg-white/95 px-4 py-4 shadow-lg shadow-emerald-900/10 ring-1 ring-emerald-50">
        {children}
      </div>

      {/* Guirlande autour, par-dessus et un peu en dehors de la carte */}
      <svg
