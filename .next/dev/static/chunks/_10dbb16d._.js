...
function LoginPage() {
    ...
    const handleLogin = async ()=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithOtp({
            email
        });
        if (error) {
...
_s(LoginPage, "tgSpMP9vfF6GNBbNf9NcNEW5Oz0=");
_c = LoginPage;
var _c;
