...
function EventPage() {
    ...
    const refreshPhotos = async (evt)=>{
        const { data: files, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from(BUCKET_NAME).list(evt.id, {
            limit: 200,
            sortBy: {
                column: "name",
                order: "asc"
        ...
        const photosWithUrl = files?.map((file)=>{
            ...
            const { data } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from(BUCKET_NAME).getPublicUrl(path);
            return {
                name: file.name,
                url: data.publicUrl,
                path
    ...
    const handleDelete = async (photo)=>{
        ...
        try {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from(BUCKET_NAME).remove([
                photo.path
            ]);
    ...
    const handleDeleteSelected = async ()=>{
        ...
        if (!ok) return;
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from(BUCKET_NAME).remove(selectedPhotos);
            if (error) throw error;
            setSelectedPhotos([]);
...
//# sourceMappingURL=_f1311b19._.js.map