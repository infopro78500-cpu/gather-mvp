...
function JoinPage() {
    ...
    const [pin, setPin] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialPin);
    ...
    const handleJoin = async (event)=>{
        ...
        setLoading(true);
        const { data, error: supabaseError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("events").select("id").eq("pin", trimmed).maybeSingle();
...
_s(JoinPage, "1NITijVfqNAWDWT7Pl98cek9RBo=", false, function() {
    return [
...
//# sourceMappingURL=_78b1a0cb._.js.map