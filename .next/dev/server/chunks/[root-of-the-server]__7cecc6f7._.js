...
async function POST(req) {
    try {
        ...
        const { email, full_name, interest_investing, interest_contributing, interest_ambassador, interest_beta_tester, message, source } = body;
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('leads_landing').insert([
            {
                email,
                full_name,
                interest_investing,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7cecc6f7._.js.map