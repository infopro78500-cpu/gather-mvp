...
function EventPage() {
    ...
    const refreshPhotos = async (evt)=>{
        const { data: files, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from("photos").list(evt.id, {
            limit: 200,
            sortBy: {
                column: "name",
                order: "asc"
        ...
        const photosWithUrl = files?.map((file)=>{
            ...
            const { data } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from("photos").getPublicUrl(path);
            return {
                name: file.name,
                url: data.publicUrl,
                path
    ...
    const handleUpload = async (e)=>{
        ...
        try {
            ...
            await Promise.all(filesArray.map(async (file)=>{
                ...
                const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from("photos").upload(filePath, file);
    ...
    const handleDelete = async (photo)=>{
        ...
        try {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from("photos").remove([
                photo.path
            ]);
            if (error) throw error;
            await refreshPhotos(event);
    ...
    const handleDeleteSelected = async ()=>{
        ...
        if (!ok) return;
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from("photos").remove(selectedPhotos);
            if (error) throw error;
            setSelectedPhotos([]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ddf343f0._.js.map